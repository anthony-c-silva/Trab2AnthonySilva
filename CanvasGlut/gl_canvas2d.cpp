...
// Implementacao adicionada para aceitar objetos Vector2 diretamente na linha
...
void CV::text(float x, float y, const char* t)
{
    ...
    for (int c = 0; c < tam; c++)
    {
        glRasterPos2i((int)x + c * 10, (int)y);
